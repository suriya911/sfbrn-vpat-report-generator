...
class SettingsDialog(tk.Toplevel):
    ...
    def __init__(self, parent, first_run=False):
        ...
        tk.Button(btn_row, text="Grading Policy…", font=("Segoe UI", 9),
                  bg=BG_SECTION, fg=FG_NAVY, relief="flat", padx=16, pady=6,
                  cursor="hand2", command=self._open_grading).pack(side="left", padx=6)
        if not first_run:
